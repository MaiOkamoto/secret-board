...
const oneTimeTokenMap = new Map(); //キーをユーザー名、値をトークンにする連想配列

function handle(req, res) {
  //アクセスがあったらcookie情報を取得
...
function isValidTrackingId(trackingId, userName) {
  ...
  const requestHash = splitted[1];
  return createValidHash(originalId, userName) === requestHash;
}
